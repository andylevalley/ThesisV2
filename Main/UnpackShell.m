...
numvars = NumberMarks + NumberMarks*2+2+NumberMarks;
...
lb = [repmat(1,1,NumberMarks),repmat([lb_loiter,lb_transfer],1,(NumberMarks*2+2)/2),ones(1,NumberMarks)*lb_beta];
ub = [repmat(NumberMarks,1,NumberMarks),repmat([ub_loiter,ub_transfer],1,(NumberMarks*2+2)/2),ones(1,NumberMarks)*ub_beta];
