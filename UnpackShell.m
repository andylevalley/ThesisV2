...
numvars = NumberMarks + NumberMarks*2+2;
...
lb = [repmat(1,1,NumberMarks), repmat([lb_loiter,lb_transfer],1,(numvars-NumberMarks)/2)];
ub = [repmat(NumberMarks,1,NumberMarks), repmat([ub_loiter,ub_transfer],1,(numvars-NumberMarks)/2)];
